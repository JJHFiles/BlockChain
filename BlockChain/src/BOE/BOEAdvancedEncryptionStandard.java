 ...
 */
public class BOEAdvancedEncryptionStandard {
...
//   
//    BOEAdvancedEncryptionStandard aes = new BOEAdvancedEncryptionStandard("1234567123456712");
//    aes.encrypt();
//    aes.decrypt();
//    }
    
     /* Clave usada para encriptado y desencriptado, de 16 caracteres
      * La contraseña se recibe desde GUILogin a traves del constructor
    ...
    public BOEAdvancedEncryptionStandard(String clave){
    ...
    public void encrypt() {
        try {
            ...
            secretkey = cifrarFichero("src\\BOE\\nodes");
    ...
    public String decrypt() {
        ...
        try {
            ...
            ipPort = descifrarFichero("src\\BOE\\nodes.encrypt", secretkey,
                    "src\\BOE\\nodes.decrypt");

        } catch (NoSuchAlgorithmException ex) {
            Logger.getLogger(BOEAdvancedEncryptionStandard.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private SecretKey cifrarFichero(String file)
        ...
        // Inicializa el objeto Cipher en modo de operación ENCRIPTACIÃON con claveSimetrica simétrica
    ...
    // Pasándole también la secretkey simétrica 
    private String descifrarFichero(String fileEntrada, Key claveSimetrica, String fileSalida)
        ...
        // Inicializa el objeto Cipher en modo de operación DESENCRIPTACI“N con secretkey simétrica
