...
//   
//    NodeAdvancedEncryptionStandard aes = new NodeAdvancedEncryptionStandard("A1234567A1234567");
//    aes.encrypt();
//    aes.decrypt();
//    }
    ...
    public void encrypt() {
        try {
            ...
            secretkey = cifrarFichero("src\\ValidatorServerSSL2\\nodes");
    ...
    public String decrypt() {
        ...
        try {
            ...
            ipPort = descifrarFichero("src\\ValidatorServerSSL2\\nodes.encrypt", secretkey,
                    "src\\ValidatorServerSSL2\\nodes.decrypt");
    ...
    private String descifrarFichero(String fileEntrada, Key claveSimetrica, String fileSalida)
        ...
        // Lee el fichero de mil en mil y pasa los fragmentos leídos al objeto Cipher
        bytesLeidos = fe.read(buffer, 0, 1000);
