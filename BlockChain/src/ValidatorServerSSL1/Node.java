 ...
 * la Ip de este nodo es la 192.168.1.231
 */
public class Node {
    ...
    public Node() {
        ...
        System.setProperty("javax.net.ssl.keyStore", "src\\ValidatorServerSSL1\\RSA_StoreSSL");

        // La clave "keyStorePassword" contiene la clave del certificado
        ...
        // Único método de la clase, lanza el Nodo para la espera de conexiones
        loadServer();
    }
    ...
    public void loadServer() {
        try {
            ...
            // Se prepara el socket seguro del server, se le pasa, puerto, número máximo de conexiones en cola e IP
            ...
            System.out.println(" ***** NODO/SERVIDOR 1 *****");
