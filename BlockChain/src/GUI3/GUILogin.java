 ...
 * caido se conecta con el alternativo y así sucesivamente. Las IP de los nodos
...
public class GUILogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldEntityCif.setText("C12345678");
        ...
        jLabel5.setText("Javier Juarros Huerga - TFG ");
    ...
    // Boton que envia al nodo los datos del cliente Entidad y password, o bien registra una entdad nueva en el nodo
    private void jButtonLoadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoadActionPerformed

        // Se genera un bloque temporal tb (temporary block)
        TempBlock tb = new TempBlock();

        // Se recogen los valores escritos en los TextBoxes que con comunes en las dos opc de checkbox
        ...
        // Busca un nodo disponible y se conecta, IPs de conexion: "192.168.0.231" o "192.168.0.232"
        this.setAliveNode();

        // Si la entidad ya existe y queremos efectuar transacciónes, se seleccin CheckBox
        if (!this.jCheckBox1.isSelected()) {

            // Envia peticion a nodo de validación si existen cif y password en la blockchain, devuelve true o false
            tb.setTask("receiveClientValidation");

            // Enviando peticion y recibiendo respuesta en bloque temporal (tb)
            tb = nodeClient.getBlockFromServer(tb);

            // Si la respuesta es true, el cif de la entidad es correcto y la password tambien
            ...
            // Envia la peticion y recibe true si la ha creado y false si el el CIF de la entidad ya existia.
            tb = nodeClient.getBlockFromServer(tb);
    ...
    // Metodo para poder cambiar color y texto del botón, se activa cuando se pulsa
    ...
    // Metodo recurrente para seleccionar un nodo disponible.
