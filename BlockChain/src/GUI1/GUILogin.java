...
public class GUILogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldEntityCif.setText("A12345678");
    ...
    private void jButtonLoadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoadActionPerformed
        ...
        // Si la entidad ya existe y queremos efectuar transacciones, se selecciona CheckBox
        if (!this.jCheckBox1.isSelected()) {
            ...
            if (tb.getTask().equals("true")) {
                ...
                // Se cierra la ventana de login y se abrira la de efectuar transacciones
                this.dispose();

                // Abre la ventana de transacciones, le pasa los datos del cliente validado (TempBlock) y la conexión con el nodo (cliente)
            ...
            // El checkbox de creación de nueva entidad ha sido seleccionado, se creará una entidad nueva y despues se podran efectuar transacciones
        } else {
            ...
            if (tb.getTask().equals("true")) {
                ...
                // Abre la ventana de transacciones le envia los datos de la entidad (tb) y el cliente del nodo (nodeClient)
                GUITransactions c2 = new GUITransactions(tb, nodeClient, this.nodeIp1, this.nodeIp2, this.smartcontractIp);
