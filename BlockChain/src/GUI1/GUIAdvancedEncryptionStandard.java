...
public class GUIAdvancedEncryptionStandard {
    ...
    /* Main a utilizar para cifrar o descifrar ficheros. solo ha de habilitarse para generar nuevos 
...
//    }
    ...
    public void encrypt() {
        try {
            ...
            secretkey = cifrarFichero("src\\GUI1\\nodes");
    ...
    public String decrypt() {
        ...
        try {
            ...
            ipPort = descifrarFichero("src\\GUI1\\nodes.encrypt", secretkey,
                    "src\\GUI1\\nodes.decrypt");
    ...
    private SecretKey cifrarFichero(String file)
        ...
        // Inicializa el objeto Cipher en modo de operación ENCRIPTACIÓN con clave simétrica
        ...
        // Lee el fichero de mil en mil y pasa los fragmentos leídos para el cifrado
    ...
    private String descifrarFichero(String fileEntrada, Key claveSimetrica, String fileSalida)
        ...
        // Inicializa el objeto Cipher en modo de operación DESENCRIPTACIÓN con secretkey simétrica
